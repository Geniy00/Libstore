...
CREATE TABLE `image` (
  ...
  KEY `lib_foreign_key` (`library_fk`),
  CONSTRAINT `lib_foreign_key` FOREIGN KEY (`library_fk`) REFERENCES `library` (`idlibrary`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2014-04-03 17:16:15
